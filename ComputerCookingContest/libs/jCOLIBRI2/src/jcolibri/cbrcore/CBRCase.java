...
public class CBRCase extends CBRQuery  {
	...
	public CBRCase(CaseComponent solution, CaseComponent justificationOfSolution, CaseComponent result, CaseComponent description) {
	...
	public CBRCase getClone(CaseComponent solution, CaseComponent justificationOfSolution, CaseComponent result, CaseComponent description) {
		
		return new CBRCase(solution, justificationOfSolution, result, description);
