...
public class PnlConceptsTree extends JPanel  implements TreeSelectionListener{
	...
	private static 	Icon CONCEPT = new javax.swing.ImageIcon(PnlConceptsTree.class.getResource("/es/ucm/fdi/gaia/ontobridge/test/gui/class-orange.gif"));

	
	private static int maxdepth = 20; //Constant to avoid cycles;
	private int minIndexOfSelections = 0;
    ...
    public void setMinIndexOfSelections(int index){
    	
    	minIndexOfSelections = index;
	...
	protected void createComponents(){
        ...
        ontologyTree.addMouseListener(new MouseAdapter() {
            public void mousePressed(MouseEvent e) {
                ...
                //Si se clica el botón derecho del ratón, se pregunta si se quiere
                //añadir el concepto
				if(selRow > minIndexOfSelections && SwingUtilities.isRightMouseButton(e)) {
					
					selectedConcept = selPath.toString();
                    SandwichOntology.getSelectedConcept(selectedConcept);
